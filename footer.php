<footer>
   ...
   <section class="it-footer-wrap it-footer-style-2 fix">
      <div class="it-footer-area z-index-1 pt-200">
                  ...
                  <div class="it-footer-widget it-footer-col-1-4 d-flex justify-content-lg-end">
                     <div>
                        ...
                        <div class="it-footer-widget-contact mb-25">
                           <ul>
                              <li><span>Phone:</span><a href="tel:+91123456789">XXXX XXXX XXXX</a></li>
                              <li><span>Email:</span><a href="mailto:educeet@gmail.com">school@gmail.com</a></li>
                              <li><span>Location:</span><a target="_blank" href="#">XXX, Germany</a></li>
                           </ul>
                        </div>
            ...
            <div class="row align-items-center">
               <div class="col-12">
                  <div class="it-copyright-left style-2 text-center">
                     <p class="mb-0">Copyright © 2026 <a href="#">German School</a>. All Rights Reserved.</p>
                  </div>
               </div>
            </div>
         </div>
