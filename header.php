...
<head>
   ...
   <title>Germany International School - Excellence in Education</title>
   <meta name="description" content="Germany International School delivers world-class education, leadership development, and a supportive environment for every student.">
   <meta property="og:title" content="Germany International School - Excellence in Education">
   <meta property="og:description" content="Germany International School delivers world-class education, leadership development, and a supportive environment for every student.">
      ...
      <div id="it-loading-center">
         <div id="it-loading-absolute">
            <div class="it-loading-content">
               <img class="it-loading-logo" src="assets/img/logo/pencil-upper.png" alt="">
   ...
   <div class="it-offcanvas-area">
      <div class="itoffcanvas">
        ...
        <div class="itoffcanvas__logo">
            <a href="index.html">
               <img src="assets/img/logo/logo-new.png" alt="Germany International School Logo">
            </a>
         </div>
            ...
            <div class="row align-items-center">
               <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-6">
                  <div class="it-header-logo">
                     <a href="./"><img src="assets/img/logo/logo-new.png" alt="Germany International School Logo"></a>
                  </div>
               </div>
               <div class="col-xxl-9 col-xl-9 col-lg-8 col-md-6 d-none d-xl-block">
                     ...
                     <nav class="it-menu-content">
                        <ul>
                              ...
                              <ul class="it-submenu submenu">
                                 ...
                                 <li><a href="#">Data Management</a></li>
                                  <li><a href="#">Finances</a></li>
                                   <li><a href="#">Language competition</a></li>
                           ...
                           <li class="has-dropdown">
                              <a href="#">Blog</a>
                              <ul class="it-submenu submenu">
                                 <li><a href="#">Generally</a></li>
                                 <li><a href="#">Education</a></li>
                                 <li><a href="#">Test</a></li>
                                 <li><a href="#">Language competition</a></li>
                                 <li><a href="#">Art Details</a></li>
                                 <li><a href="#">Sports</a></li>
                              </ul>
                           </li>
               ...
               <div class="col-6 d-xl-none text-end">
                  <div class="it-header-bar">
                     <button class="it-menu-bar" aria-label="Open menu">
                        <span>
